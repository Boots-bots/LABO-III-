...
# Pasa Banda RLC
    ...
    wo1  = 1/np.sqrt(pop_Fase[1]*pop_Fase[2])
    print("Ajustes")
    print("Fase")
    ...
    wo2 = 1/np.sqrt(pop_Trans[1]*pop_Trans[2])
    dw2 = pop_Trans[0]/pop_Trans[1]
    print("Transferencia")
    ...
    wo3 = 1/np.sqrt(pop_Att[1]*pop_Att[2])
    dw3 = pop_Att[0]/pop_Att[1]
    print("Atenuación")
    ...
    plt.axvline(x= wo1, color='g', linestyle='--', label = f"ω0 = {w0:.1f}") 
    plt.plot(ejex, fase(ejex, *pop_Fase), "r", label ="Ajuste")
    ...
    plt.errorbar(w, dif_amp, dif_amp_std, fmt='.', label = "Mediciones")
    plt.axhline(y=0.7, color='g', linestyle='--', label = "70%") 
    plt.axvline(x=wo2, color='g', linestyle='--', label = f"ω0 = {w0:.1f}")
    plt.axvline(x= wo2 + dw, color='darkgreen', linestyle='-', label = f"Δω = {pop_Trans[0]/pop_Trans[1]:.1f}")
    plt.plot(ejex, Transferencia(ejex, *pop_Trans), "r", label ="Ajuste")
    ...
    plt.errorbar(w, Att, Attstd, fmt='.', label = "Mediciones")
    plt.axhline(y=-3.01, color='g', linestyle='--', label = "- 3.01 dB") 
    plt.axvline(x=wo3, color='g', linestyle='--', label = f"ω0 = {w0:.1f}")
    plt.axvline(x=wo3+dw, color='darkgreen', linestyle='--', label = f"Δω = {dw:.1f}")
    plt.axvline(x=wo3-dw, color='darkgreen', linestyle='-')
    plt.plot(ejex, Atenuación2(ejex, *pop_Att), "r", label ="Ajuste")
    ...
    print("no se seleccionó un circuito válido")