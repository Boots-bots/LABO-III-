...
ampere = (205, 181, 160.9, 122, 98.5, 82.5, 71, 62.1, 55.3, 50, 25, 16.7, 12.5, 10, 8.3, 7.1, 6.2, 5.5, 4.9) #mA #181, 
...
pop = Minimizer(modelo, oms, potencia, std, (25), metodo = "Newton-CG")
# pop,cov = curve_fit(modelo, oms, potencia, (25), std, absolute_sigma = True)
...
plt.errorbar(oms, potencia, yerr = std, fmt = ".", color = "b", label = "Potencia transferida")
plt.axvline(25, linestyle = "-.", color = "brown", label = "Resistencia interna (25 ± 5)Ω") 
